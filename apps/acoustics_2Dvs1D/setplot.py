...
import os
if os.path.exists('./_output1d'):
    qref_dir = os.path.abspath('./_output1d')
else:
    qref_dir = None
    print "Directory ./_output1d not found"
...
#--------------------------
    ...
    plotfigure = plotdata.new_plotfigure(name='Difference', figno=2)

    # Set up for axes in this figure:
    plotaxes = plotfigure.new_plotaxes()
    plotaxes.xlimits = 'auto'
    plotaxes.ylimits = 'auto'
    plotaxes.title = 'Difference'
    plotaxes.scaled = True      # so aspect ratio is 1
