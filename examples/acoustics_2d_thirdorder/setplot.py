...
#--------------------------
    ...
    # Figures for gauges
    #-----------------------------------------
    plotfigure = plotdata.new_plotfigure(name='pressure', figno=300, \
                    type='each_gauge')
    ...
    plotfigure = plotdata.new_plotfigure(name='u', figno=400, \
                    type='each_gauge')
    plotfigure.clf_each_gauge = True
    ...
    plotaxes.xlimits = 'auto'
    plotaxes.ylimits = 'auto'
    plotaxes.title = 'Velocity (u component)'
    plotitem = plotaxes.new_plotitem(plot_type='1d_plot')
    plotitem.plot_var = 1
    plotitem.plotstyle = 'b-'

    plotfigure = plotdata.new_plotfigure(name='v', figno=500, \
                    type='each_gauge')
    plotfigure.clf_each_gauge = True
    ...
    plotaxes.xlimits = 'auto'
    plotaxes.ylimits = 'auto'
    plotaxes.title = 'Velocity (v component)'
    plotitem = plotaxes.new_plotitem(plot_type='1d_plot')
    plotitem.plot_var = 2
    plotitem.plotstyle = 'b-'
